...
const PORTFOLIO = [
  ...
  { title: "Веранда панорамная", area: "35 м²", material: "Ель + стекло", before: "https://cdn.poehali.dev/projects/3920dd0c-4dfa-4c78-9711-bb7b6291f67a/files/c5a62d5f-2406-4c6f-8e56-4a916b310a62.jpg", after: "https://cdn.poehali.dev/projects/3920dd0c-4dfa-4c78-9711-bb7b6291f67a/files/791b9a99-a0e1-4111-9af7-ed5921e73496.jpg" },
];

const REVIEWS = [
  { name: "Анна К.", city: "Уфа", text: "Заказывала веранду под ключ. Бригада приехала вовремя, работали аккуратно. Результат превзошёл ожидания — теперь проводим там всё лето!", stars: 5 },
  { name: "Михаил Г.", city: "Уфа", text: "Делали беседку с барбекю. Материалы отличного качества, всё задокументировано. Прошло 2 года — ни одного нарекания.", stars: 5 },
  { name: "Светлана П.", city: "Уфа", text: "Очень довольна работой. Помогли с проектом, подобрали материал под наш дом. Всё сделали за 12 дней.", stars: 5 },
];
